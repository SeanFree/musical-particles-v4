import { useEffect, useContext, useMemo, type FC } from 'react'
import {
  AudioPlayerContext,
  Button,
  MenuContext,
...
export const AppInfoModal: FC = () => {
  const { open, toggle } = useContext(MenuContext)
  const { isEditingTrack, userInitialized, setUserInitialized } =
    ...
    () => (
      ...
      >
        ...
        <footer className="mp-app-info-modal__footer">
          <p className="mp-app-info-modal__disclaimer">
