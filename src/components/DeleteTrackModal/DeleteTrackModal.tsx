...
import { AudioPlayerContext, Button, MenuContext, Modal } from '@/components'
import { DELETE_TRACK_MODAL_ID, PLAYLIST_MENU_ID } from '@/constants'

import './DeleteTrackModal.scss'

export const DeleteTrackModal: FC = () => {
  ...
  return useMemo(
    () => (
      <Modal className="mp-delete-track-modal" id={DELETE_TRACK_MODAL_ID}>
        <p className="mp-delete-track-modal__message">
