...
export const TrackInfoModal: FC = () => {
  const { currentTrack } = useContext(AudioPlayerContext)

  return useMemo(
    () => (
      <Modal className="mp-track-info-modal" id={TRACK_INFO_MODAL_ID}>
        ...
        {currentTrack ? (
          <>
            <h4 className="mp-track-info-modal__heading">
              {currentTrack.artist} - {currentTrack.title}
            </h4>
            <p className="mp-track-info-modal__subtext">
