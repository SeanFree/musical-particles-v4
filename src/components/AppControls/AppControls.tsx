...
import { Button, MenuContext, Icon } from '@/components'
import {
  PARTICLE_MENU_ID,
  PLAYLIST_MENU_ID,
  APP_INFO_MODAL_ID,
...
export const AppControls: FC<AppControlsProps> = ({ tabIndex = 0 }) => {
    ...
    <ul className="mp-app-controls">
      ...
      <li className="mp-app-controls__item">
        <Button
          ...
          variant="inline"
        >
          <Icon name="playlist_play" size="m" />
        </Button>
      </li>
    </ul>
  )
