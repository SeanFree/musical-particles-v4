...
export const FileErrorModal: FC = () => {
    ...
    () => (
      ...
      >
        <header className="mp-file-error-modal__header">
          ...
          <p className="mp-file-error-modal__info">
        ...
        <ul className="mp-file-error-modal__list">
          {errorFiles.map((file, index) => (
            <li
              className="mp-file-error-modal__item"
              key={`error-file--${index}`}
            >
              <span className="mp-file-error-modal__item-name">
                {(file as File).name}
              </span>
              <span className="mp-file-error-modal__item-type">
                {file.type}
              </span>
            </li>
          ))}
